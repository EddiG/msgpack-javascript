...
var ExtensionCodec = /** @class */ (function () {
    ...
    ExtensionCodec.prototype.register = function (_a) {
        var type = _a.type, align = _a.align, encode = _a.encode, decode = _a.decode;
        if (type >= 0) {
            // custom extensions
...
var Encoder = /** @class */ (function () {
    ...
    Encoder.prototype.encodeExtension = function (ext) {
        ...
        if (ext.align && Number.isInteger(ext.align)) {
            var align = ext.align;
            var dataPos = this.pos + 1; // + extType size
            var padding = (align - (dataPos % align)) % align;
...
var Decoder = /** @class */ (function () {
    ...
    Decoder.prototype.decodeAsync = function (stream) {
        return __awaiter(this, void 0, void 0, function () {
            var decoded, object, buffer, e_1_1, _a, headByte, pos, totalPos;
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 12:
                        ...
                        _a = this, headByte = _a.headByte, pos = _a.pos, totalPos = _a.totalPos;
    ...
    Decoder.prototype.decodeExtension = function (size, headOffset) {
        ...
        var data = this.decodeBinary(size, headOffset + padding + 1 /* extType */);
